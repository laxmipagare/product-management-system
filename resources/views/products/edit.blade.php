    ...
    <div class="app-content">
        ...
        <div class="row g-4">
            ...
            <div class="card card-info card-outline mb-4">
                ...
                <!--end::Header-->
                <!--begin::Form-->
                <form id="editproductForm" method="POST" action="javascript:void(0)" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" aria-label="textarea" name="product_description" placeholder="Product Description" required>{{ $product->product_description }}</textarea>
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6">
                    ...
                    <div>
                        @foreach($product->product_image as $img)
                            <img src="{{ asset('uploads/'.$img) }}" width="80" style="margin:5px">
                        @endforeach
                    </div>
                    </div>
